...
urlpatterns = [
    ...
    path('api/news/<int:news_id>/', views.NewsUpdateDestroyAPIView.as_view(), name='news_up'),
    path('api/news/<int:pk>/comments/', views.CommentListCreateAPIView.as_view(), name='comment'),
    path('api/news/<int:pk>/comments/<int:comment_id>/', views.CommentRetrieveUpdateDestroyAPIView.as_view()),
    ...
    path('api/news/<int:news_id>/<slug>/', views.NewsStatusAPIV.as_view(), name='news_slug'),
    path('api/news/<int:news_id>/comments/<int:comment_id>/<slug>/', views.CommentStatusAPIV.as_view(), name='com_slug'),
